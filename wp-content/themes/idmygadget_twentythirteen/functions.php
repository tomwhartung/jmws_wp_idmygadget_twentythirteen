...
function twentythirteen_idMyGadget_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Main Widget Area', 'idmygadget_twentythirteen' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Appears in the footer section of the site.', 'idmygadget_twentythirteen' ),
	...
	register_sidebar( array(
		'name'          => __( 'Secondary Widget Area', 'idmygadget_twentythirteen' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Appears on posts and pages in the sidebar.', 'idmygadget_twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
 ...
 */
function idmygadget_twentythirteen_init()
{
	register_nav_menu('phone-header-nav', __( 'Phone Header Nav', 'idmygadget_twentythirteen' ));
	register_nav_menu('phone-footer-nav', __( 'Phone Footer Nav', 'idmygadget_twentythirteen' ));
	register_nav_menu('hamburger-icon-left-nav', __( 'Hamburger Icon Left Nav', 'idmygadget_twentythirteen' ));
	register_nav_menu('hamburger-icon-right-nav', __( 'Hamburger Icon Right Nav', 'idmygadget_twentythirteen' ));
}
add_action( 'init', 'idmygadget_twentythirteen_init' );
...
function idmygadget_twentythirteen_enqueue_styles()
{
	...
	{
		$css_file = get_template_directory_uri() . "/idMyGadget/css/idMyGadget-tablet.css";
	}
	else
	{
		$css_file = get_template_directory_uri() . "/idMyGadget/css/idMyGadget-desktop.css";
	}
	wp_register_style( 'idMyGadget-deviceType-css', $css_file );
 ...
 */
function idmygadget_twentythirteen_enqueue_scripts()
{
	global $jmwsIdMyGadget;
...
add_action( 'wp_enqueue_scripts', 'idmygadget_twentythirteen_enqueue_scripts' );
